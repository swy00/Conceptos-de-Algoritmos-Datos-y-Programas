...
function sumaVector(v: vecNum): integer;
var
    suma,i: integer;
begin
    suma:=0;
...
var
    ...
    i:integer;
    x: real;
    elemMax,elemMin,posMax,posMin:integer;
begin
    stop:= false;
    i:=1;
    while(stop = false) do
    ...
    posMax:=posicion(v,elemMax,posMax);
    elemMin:=elementoMinimo(v);
    posMin:=posicion(v,elemMin,posMin);
